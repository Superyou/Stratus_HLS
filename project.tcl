...
define_hls_config digitrec ASIC
define_hls_config digitrec DPOPT -     -DUSE_DPOPT
define_hls_config digitrec VIVADO      --fpga_tool=Vivado  --fpga_part=xc7vx485tffg1158-2
define_hls_config digitrec VIVADO_DSP  --fpga_tool=Vivado  --fpga_part=xc7vx485tffg1158-2 --fpga_use_dsp=on -DUSE_DSP
define_hls_config digitrec QUARTUS     --fpga_tool=Quartus --fpga_part=5CGXFC3B6F23C6
define_hls_config digitrec QUARTUS_DSP --fpga_tool=Quartus --fpga_part=5CGXFC3B6F23C6     --fpga_use_dsp=on -DUSE_DSP
...
define_sim_config B {digitrec BEH}
...
foreach config [find -hls_config *] {
  ...
  define_sim_config ${cname}_V "digitrec RTL_V $cname"
}
...
define_logic_synthesis_config LS_ASIC        {digitrec ASIC}        -options [list BDW_LS_TECHLIB $LIB_PATH/$LIB_LEAF] {BDW_LS_CLK_GATING normal} {BDW_LS_NOGATES 1} -command bdw_runrc
define_logic_synthesis_config LS_DPOPT       {digitrec DPOPT}       -options [list BDW_LS_TECHLIB $LIB_PATH/$LIB_LEAF] {BDW_LS_CLK_GATING normal} {BDW_LS_NOGATES 1} -command bdw_runrc
define_logic_synthesis_config LS_VIVADO      {digitrec VIVADO}      -command bdw_runvivado
define_logic_synthesis_config LS_VIVADO_DSP  {digitrec VIVADO_DSP}  -command bdw_runvivado
define_logic_synthesis_config LS_QUARTUS     {digitrec QUARTUS}     -command bdw_runquartus
define_logic_synthesis_config LS_QUARTUS_DSP {digitrec QUARTUS_DSP} -command bdw_runquartdigitrec
