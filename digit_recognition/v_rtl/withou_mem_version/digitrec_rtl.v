...
module digitrec(clk, rst, cc_busy_o, cc_interrupt_o, cc_status_i, cc_exception_i, cc_host_id_i, core_cmd_ready_o, core_cmd_valid_i, core_cmd_inst_funct_i, core_cmd_inst_rs1_i, core_cmd_inst_rs2_i, core_cmd_inst_xd_i, core_cmd_inst_xs1_i, core_cmd_inst_xs2_i, core_cmd_inst_rd_i, core_cmd_inst_opcode_i, core_cmd_rs1_i, core_cmd_rs2_i, core_resp_ready_i, core_resp_valid_o, core_resp_rd_o, core_resp_data_o, mem_req_ready_i
      ...
      /*signed*/wire[11:0] digitrec_Add2i1s12_4_68_out1;
      wire digitrec_OrReduction_1U_1_4_53_out1;
      wire digitrec_LessThan_1U_24_4_51_out1;
      wire digitrec_Lti10s5_4_49_out1;
      /*signed*/wire[11:0] digitrec_Add2i1s12_4_48_out1;
      /*signed*/wire[11:0] digitrec_Add2i1s12_4_46_out1;
      /*signed*/wire[11:0] digitrec_Add2i1s12_4_29_out1;
      /*signed*/wire[11:0] digitrec_Add2i1s12_4_10_out1;
      ...
      /*signed*/reg[4:0] digitrec_Add2i1s12_4_48_in1_slice;
      reg[1:0] gs_ctrl47;
      reg[2:0] gs_ctrl46;
      reg[2:0] gs_ctrl44;
      /*signed*/reg[4:0] digitrec_Add2i1s12_4_46_in1_slice;
      reg gs_ctrl43;
      ...
      reg[5:0] knn_set_9_inst_digitrec_knn_set_9_regbank_r0;
         ...
         always @(posedge clk)
          begin :drive_s_reg_31
            case (global_state) 
               ...
               5'd09: begin
                  s_reg_31 <= digitrec_Add2i1s12_4_10_out1[4:0];
               end
         ...
         always @(posedge clk)
          begin :drive_s_reg_35
            case (global_state) 
               ...
               5'd13, 5'd14: begin
                  s_reg_35 <= digitrec_Add2i1s12_4_46_out1[4:0];
               end
         ...
         always @(posedge clk)
          begin :drive_s_reg_41
            case (global_state) 
               ...
               5'd14, 5'd16: begin
                  s_reg_41 <= digitrec_Add2i1s12_4_48_out1[4:0];
               end
         ...
         always @(posedge clk)
          begin :drive_s_reg_52
            s_reg_52 <= digitrec_Add2i1s12_4_68_out1[4:0];
         end
         ...
         assign digitrec_Add2i1s12_4_10_out1 = {{ 7 {s_reg_30[4]}}, s_reg_30} + 12'd0001;
         ...
         // resource: mux_5bx2i
         always @(gs_ctrl43 or s_reg_35)
          begin :drive_digitrec_Add2i1s12_4_46_in1
            if (gs_ctrl43) begin
               digitrec_Add2i1s12_4_46_in1_slice = s_reg_35;
            end
            else begin
               digitrec_Add2i1s12_4_46_in1_slice = 5'd00;
            end
         end

         // resource: digitrec_Add2i1s12_4  instance: digitrec_Add2i1s12_4_46
         assign digitrec_Add2i1s12_4_46_out1 = {{ 7 {digitrec_Add2i1s12_4_46_in1_slice[4]}}, digitrec_Add2i1s12_4_46_in1_slice} + 12'd0001;
         ...
         // resource: mux_5bx2i
         always @(gs_ctrl32 or s_reg_41)
          begin :drive_digitrec_Add2i1s12_4_48_in1
            if (gs_ctrl32) begin
               digitrec_Add2i1s12_4_48_in1_slice = s_reg_41;
            end
            else begin
               digitrec_Add2i1s12_4_48_in1_slice = 5'd00;
            end
         end

         // resource: digitrec_Add2i1s12_4  instance: digitrec_Add2i1s12_4_48
         assign digitrec_Add2i1s12_4_48_out1 = {{ 7 {digitrec_Add2i1s12_4_48_in1_slice[4]}}, digitrec_Add2i1s12_4_48_in1_slice} + 12'd0001;
         ...
         assign digitrec_Add2i1s12_4_68_out1 = {{ 7 {s_reg_51[4]}}, s_reg_51} + 12'd0001;
