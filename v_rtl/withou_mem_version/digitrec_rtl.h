...
struct digitrec : public sc_module {
  ...
  sc_signal<sc_int<5> > digitrec_Add2i1s5_4_10_in1;
  ...
  sc_signal<sc_int<5> > digitrec_Add2i1s5_4_10_out1;
  ...
  void drive_digitrec_Add2i1s5_4_10_in1();
  void digitrec_Add2i1s5_4_10();
