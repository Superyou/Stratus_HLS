...
module digitrec(clk, rst, cc_busy_o, cc_interrupt_o, cc_status_i, cc_exception_i, cc_host_id_i, core_cmd_ready_o, core_cmd_valid_i, core_cmd_inst_funct_i, core_cmd_inst_rs1_i, core_cmd_inst_rs2_i, core_cmd_inst_xd_i, core_cmd_inst_xs1_i, core_cmd_inst_xs2_i, core_cmd_inst_rd_i, core_cmd_inst_opcode_i, core_cmd_rs1_i, core_cmd_rs2_i, core_resp_ready_i, core_resp_valid_o, core_resp_rd_o, core_resp_data_o
      ...
      /*signed*/wire[11:0] digitrec_Add2i1s12_4_53_out1;
      /*signed*/wire[11:0] digitrec_Add2i1s12_4_56_out1;
      /*signed*/wire[11:0] digitrec_Add2i1s12_4_1_out1;
      ...
      /*signed*/reg[4:0] digitrec_Add2i1s12_4_1_in1_slice;
      reg gs_ctrl32;
      reg s_reg_72;
      reg[4:0] s_reg_71;
      reg[4:0] s_reg_70;
      ...
      reg[48:0] tmp_inst_digitrec_tmp_regbank_r9;
         ...
         // resource: mux_1bx2i
         always @(gs_ctrl31 or mem_req_ready_i or digitrec_And_1U_3_4_50_out1)
         ...
         always @(posedge clk)
          begin :drive_s_reg_50
            case (global_state) 
               ...
               5'd02, 5'd03: begin
                  s_reg_50 <= digitrec_Add2i1s12_4_1_out1[4:0];
               end
         ...
         always @(posedge clk)
          begin :drive_s_reg_55
            s_reg_55 <= digitrec_Add2i1s12_4_53_out1[4:0];
         end
         ...
         always @(posedge clk)
          begin :drive_s_reg_56
            case (global_state) 
               ...
               5'd04, 5'd05: begin
                  s_reg_56 <= digitrec_Add2i1s12_4_55_out1[4:0];
               end
         ...
         always @(posedge clk)
          begin :drive_s_reg_62
            case (global_state) 
               ...
               5'd05, 5'd07: begin
                  s_reg_62 <= digitrec_Add2i1s12_4_59_out1[4:0];
               end
         ...
         always @(posedge clk)
          begin :drive_s_reg_71
            s_reg_71 <= digitrec_Add2i1s12_4_79_out1[4:0];
         end
         ...
         always @(gs_ctrl32 or s_reg_50)
          begin :drive_digitrec_Add2i1s12_4_1_in1
            if (gs_ctrl32) begin
               digitrec_Add2i1s12_4_1_in1_slice = s_reg_50;
            end
            else begin
               digitrec_Add2i1s12_4_1_in1_slice = 5'd00;
            end
         end

         // resource: digitrec_Add2i1s12_4  instance: digitrec_Add2i1s12_4_1
         assign digitrec_Add2i1s12_4_1_out1 = {{ 7 {digitrec_Add2i1s12_4_1_in1_slice[4]}}, digitrec_Add2i1s12_4_1_in1_slice} + 12'd0001;

         // resource: digitrec_Lti10s5_4  instance: digitrec_Lti10s5_4_2
         assign digitrec_Lti10s5_4_2_out1 = digitrec_Add2i1s12_4_1_out1[4] ^ digitrec_Add2i1s12_4_1_out1[4:0] < 5'd10;
         ...
         assign digitrec_Equal_1U_24_4_49_out1 = mem_resp_tag_i == s_reg_54;
         ...
         assign digitrec_Add2i1s12_4_53_out1 = {{ 7 {s_reg_53[4]}}, s_reg_53} + 12'd0001;
         ...
         always @(gs_ctrl78 or s_reg_56)
          begin :drive_digitrec_Add2i1s12_4_55_in1
            if (gs_ctrl78) begin
               digitrec_Add2i1s12_4_55_in1_slice = s_reg_56;
            end
            else begin
         ...
         always @(gs_ctrl43 or s_reg_62)
          begin :drive_digitrec_Add2i1s12_4_59_in1
            if (gs_ctrl43) begin
               digitrec_Add2i1s12_4_59_in1_slice = s_reg_62;
            end
            else begin
         ...
         assign digitrec_Add2i1s12_4_79_out1 = {{ 7 {s_reg_70[4]}}, s_reg_70} + 12'd0001;
         ...
         // resource: mux_5bx13i
         always @(global_state or core_cmd_valid_i or s_reg_43 or s_reg_45 or digitrec_Lti10s5_4_2_out1 or digitrec_LtiLLs12_4_48_out1 or digitrec_Lti10s5_4_57_out1 or s_reg_63 or digitrec_Lti10s5_4_82_out1 or mem_req_ready_i or digitrec_And_1U_3_4_50_out1 or digitrec_Lti10s5_4_54_out1 or digitrec_LtiLLs12_4_58_out1 or core_resp_ready_i)
         ...
         assign mem_req_tag_o = {{ 5 {sreg_1[4]}}, sreg_1};

         assign s_reg_54 = {{ 5 {sreg_1[4]}}, sreg_1};

         assign s_reg_60 = sreg_2;

         assign s_reg_61 = sreg_2[3:0];
